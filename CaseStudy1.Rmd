...
## Data Driven Brewing
Though small, most of the breweries are making complex beers for an ever growing market of consumers who want to know more about beer. All 2,410 beers in the data set had a specified style and type, 97% of the beers had a specified ABV, and 58% of the beers had a specified IBU.      
```{r}
